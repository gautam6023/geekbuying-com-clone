...
{
    var arr = ["translateX(-500%)","translateX(-1000%)","translateX(-1500%)","translateX(-2000%)","translateX(-2500%)","translateX(-3000%)","translateX(-3500%)","translateX(-4000%)"]
    var arr2 = ["translateX(0%)","translateX(0%)","translateX(-500%)","translateX(-1000%)","translateX(-1500%)","translateX(-2000%)","translateX(-2500%)","translateX(-3000%)","translateX(-3500%)"]
    console.log(index);
    if(index>0)
    {
...
document.querySelector("#innercontainer4").addEventListener("mouseenter",displaybuttonsFun)
document.querySelector("#innercontainer5").addEventListener("mouseenter",displaybuttonsFun)

function displaybuttonsFun(event)
{
    event.target.firstElementChild.nextElementSibling.classList.remove("class","fade")
    event.target.firstElementChild.classList.remove("class","fade");
}

document.querySelector("#innercontainer4").addEventListener("mouseleave",hidebuttonsFun)
document.querySelector("#innercontainer5").addEventListener("mouseleave",hidebuttonsFun)

function hidebuttonsFun(event)
{
    event.target.firstElementChild.nextElementSibling.classList.add("class","fade")
...
{
    var arr3 = ["translateX(-500%)","translateX(-1000%)","translateX(-1500%)","translateX(-2000%)","translateX(-2500%)","translateX(-3000%)","translateX(-3500%)","translateX(-4000%)"]
    var arr4 = ["translateX(0%)","translateX(0%)","translateX(-500%)","translateX(-1000%)","translateX(-1500%)","translateX(-2000%)","translateX(-2500%)","translateX(-3000%)","translateX(-3500%)"]
    console.log(index);
    if(index>0)
    {
...
document.querySelector("#innercontainer7").addEventListener("mouseenter",displaybuttonsFun)
document.querySelector("#innercontainer8").addEventListener("mouseenter",displaybuttonsFun)

document.querySelector("#innercontainer7").addEventListener("mouseleave",hidebuttonsFun)
document.querySelector("#innercontainer8").addEventListener("mouseleave",hidebuttonsFun)